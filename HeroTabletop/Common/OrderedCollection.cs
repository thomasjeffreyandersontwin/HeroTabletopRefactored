...
namespace HeroVirtualTabletop.Common
{
    ...
    public class OrderedCollectionImpl<T> : ObservableDictionary<string, T>, OrderedCollection<T> where T : OrderedElement
    {
    ...
    [Serializable]
    public class ObservableDictionary<TKey, TValue> : PropertyChangedBase,
