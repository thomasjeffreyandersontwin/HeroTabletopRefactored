...
namespace HeroUI
{
    ...
    public interface PopupService
    {
        ...
        void ShowDialog(string key, object viewModel, bool isModal, Action<CancelEventArgs> winClosing = null, System.Windows.Media.SolidColorBrush background = null, System.Windows.Style customStyle = null, WindowStartupLocation location = WindowStartupLocation.CenterOwner, WindowLocation customLocation = WindowLocation.Ignore);
        void ShowDialog(string key, object viewModel, string title, bool isModal, Action<CancelEventArgs> winClosing = null, System.Windows.Media.SolidColorBrush background = null, System.Windows.Style customStyle = null, WindowStartupLocation location = WindowStartupLocation.CenterOwner, WindowLocation customLocation = WindowLocation.Ignore);
        void ShowDialog(string key, object viewModel, string title, Dictionary<string, object> ctrlPropertiesToSet,
    ...
    public class PopupServiceImpl : PopupService
    {
        ...
        public PopupServiceImpl(IEventAggregator eventAggregator)
        {
        ...
        public void ShowDialog(string key, object viewModel, bool isModal = true, Action<CancelEventArgs> winClosing = null, SolidColorBrush background = null, System.Windows.Style customStyle = null, WindowStartupLocation location = WindowStartupLocation.CenterOwner, WindowLocation customLocation = WindowLocation.Ignore)
        {
            ...
            Action<CancelEventArgs> winClosing = null, SolidColorBrush background = null, System.Windows.Style customStyle = null, WindowStartupLocation location = WindowStartupLocation.CenterOwner, WindowLocation customLocation = WindowLocation.Ignore)
        {
            ...
            this.eventAggregator.PublishOnUIThread(new PopupOpenedEvent { PopupWindow = win});
